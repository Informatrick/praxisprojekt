...
|----|---------|-------------|--------|------|---------|
| PROJ-1 | Benutzerkonten & Login | Registrierung, Login und Profil mit Standard-Standort; etabliert das Muster, dass jeder Nutzer nur seine eigenen Daten sieht (Row Level Security). | In Progress | [PROJ-1](PROJ-1-user-accounts-login/) | 2026-08-27 |
